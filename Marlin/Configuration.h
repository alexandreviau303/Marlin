...
#define MAX_OVERSHOOT_PID_AUTOTUNE 60
  ...
  #else
    #define DEFAULT_Kp  7.63//21.73
    #define DEFAULT_Ki   0.28//1.54
    #define DEFAULT_Kd  52.15//76.55
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 669 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, 5, -3.200 }
